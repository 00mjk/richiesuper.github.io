#!/bin/sh
# Richie's Auto Rice Boostrapping Script (RARBS)
# by Richie Seputro
# License: GNU GPLv3
...
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/richiesuper/whiterice.git"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/richiesuper/RARBS/main/progs.csv"
...
welcomemsg() { \
	dialog --title "Welcome!" --msgbox "Welcome to Richie's Auto-Rice Bootstrapping Script!\\n\\nThis script will automatically install a fully-featured Linux desktop, which I use as my desktop PC operating system.\\n\\n-Richie" 10 60

	dialog --colors --title "Important Note!" --yes-label "All ready!" --no-label "Return..." --yesno "Be sure the computer you are using has the current pacman updates and refreshed Arch keyrings.\\n\\nIf it does not, the installation of some programs might fail." 8 70
	}
...
preinstallmsg() { \
	dialog --title "Let's get this started!" --yes-label "Let's go!" --no-label "No, nevermind!" --yesno "The rest of the installation will now be totally automated, so you can sit back and relax.\\n\\nIt will take some time, but when it's done, you can relax even more with your complete system.\\n\\nNow just press <Let's go!> and the system will begin installation!" 13 60 || { clear; exit 1; }
	}
...
# Make pacman and yay colorful and adds eye candy on the progress bar because why not XD.
